...
/**
 * Vector models a 2 dimensional Vector. It can be used as a coordinate, a
 * dimension bounds, a direction or anything you can think of by vectors. The
 * meaning of a vector should be documented and/or be given by the attribute
 * name.
 *
 * @author Patrick Loka
 * @version 1.0
...
public class Vector {
     ...
     *
     * @param addend
     *            vector, which should be added.
     * @return A new Vector instance representing the sum of this vector and the
     *         addend vector.
     * @since 1.0
     */
     ...
     *
     * @param subtrahend
     *            vector, which should be subtracted.
     * @return A new Vector instance representing the difference between this
     *         vector as minor and the input as subtrahend vector.
     * @since 1.0
     */
     ...
     * @return A new Vector instance representing the product of the input
     *         factor and this vector.
     * @since 1.0
     */
     ...
     *
     * @param goal
     *            point to go from this vector in resulting direction.
