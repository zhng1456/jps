...
/**
 * BoundingBox represents an axes parallel rectangle in the 2 dimension space
 * around all vectors, which ever where included to it.
 *
 * @author Patrick Loka
 * @version 1.0
 * @since 1.0
...
public class BoundingBox {
     ...
     *
     * @param vector
     *            first vector in the new bounding box.
     * @since 1.0
     */
     ...
     *
     * @param bb
     *            bounding box which should be copied.
     * @since 1.0
     */
     ...
     *
     * @param vector
     *            given vector to include to the bounding box.
     * @since 1.0
     */
     ...
     *
     * @param bb
     *            bounding box to union to this bounding box.
     * @since 1.0
     */
    ...
    public boolean isInBoundingBox(Vector testPoint) {
        return this.minX <= testPoint.getX() && testPoint.getX() <= this.maxX && this.minY <= testPoint.getY()
                && testPoint.getY() <= this.maxY;
    }
