...
/**
 * The MapFacade interface allows to share information about the state of an
 * specific implementation without giving the opportunity to manipulate data.
 * (read only)
 *
 * @author Patrick Loka
 * @version 1.0
...
public interface MapFacade {
     ...
     * <br>
     * A valid implementation returns only true, iff the vector is explicit
     * marked as passable
     *
     * @param vector
