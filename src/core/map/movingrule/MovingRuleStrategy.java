...
/**
 * MovingRuleStrategy provides the opportunity to memorise a specific MovingRule
 * implementation to give it back whenever needed.
 *
 * @author Patrick Loka
 * @version 1.0
 * @see MapController
...
public class MovingRuleStrategy {
     ...
     *
     * @return The memorised MovingRule implementation. Returns null if no
