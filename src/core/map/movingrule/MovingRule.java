 ...
 * <br>
 * A MovingRule also defines forced- and SubDirections considering the given
 * movement rules.
 *
 * @author Patrick Loka
 * @version 1.0
...
public abstract class MovingRule {
     ...
     * <br>
     * Default Implementation: Returns all orthogonal and diagonal directions in
     * a 2-dimensional space.<br>
     *
     ...
     * <br>
     * A valid implementation returns all forced directions considering the
     * implementation specific definition of a forced point considering the
     * accepted moving rules.<br>
     *
     * @param map
    ...
    /**
     * Returns all subordinated directions of a prioritized input direction
     * considering the accepted moving rules.<br>
     * <br>
     * Default Implementation (diagonal first): If the input is a basis vector,
     * return an empty set. Else return a set of the basis vectors which add up
     * to the input.<br>
     *
     * @param direction
    ...
    /**
     * Returns true, if a corner is cut without permission by moving in input
     * direction by leaving currentPoint. Otherwise returns false.<br>
     * <br>
     * Default Implementation(Corner Cutting is allowed): Corner is independent
     * of the input never cut.<br>
     *
     * @param map
     *            map to apply moving rules.
     * @param currentPoint
